...
public class MoCEntityFXVacuum extends EntityFX {
    ...
    /*public MoCEntityFXVaccum(World par1World, double par2, double par4, double par6, double par8, double par10, double par12)
    {
    ...
    public void renderParticle(Tessellator par1Tessellator, float par2, float par3, float par4, float par5, float par6, float par7)
    {
        float var7 = ((float) this.particleAge + par2) / (float) this.particleMaxAge;
        var7 = 1.0F - var7;
        var7 *= var7;
        var7 = 1.0F - var7;
        this.particleScale = this.portalParticleScale * var7;
