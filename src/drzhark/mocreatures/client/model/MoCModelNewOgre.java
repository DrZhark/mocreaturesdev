...
import drzhark.mocreatures.entity.monster.MoCEntityNewOgre;
...
public class MoCModelNewOgre extends ModelBase
{
	ModelRenderer Head;
	ModelRenderer Brow;
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		MoCEntityNewOgre entityogre = (MoCEntityNewOgre) entity;
