...
import drzhark.mocreatures.client.renderer.entity.MoCRenderAnt;
import drzhark.mocreatures.client.renderer.entity.MoCRenderBee;
import drzhark.mocreatures.client.renderer.entity.MoCRenderCrab;
import drzhark.mocreatures.client.renderer.entity.MoCRenderDragonfly;
import drzhark.mocreatures.client.renderer.entity.MoCRenderDuck;
import drzhark.mocreatures.client.renderer.entity.MoCRenderElephant;
import drzhark.mocreatures.client.renderer.entity.MoCRenderFly;
import drzhark.mocreatures.client.renderer.entity.MoCRenderFox;
import drzhark.mocreatures.client.renderer.entity.MoCRenderKomodo;
import drzhark.mocreatures.client.renderer.entity.MoCRenderMaggot;
import drzhark.mocreatures.client.renderer.entity.MoCRenderMediumFish;
import drzhark.mocreatures.client.renderer.entity.MoCRenderMiniGolem;
...
import drzhark.mocreatures.client.renderer.entity.MoCRenderOgre;
...
import drzhark.mocreatures.client.renderer.entity.MoCRenderPiranha;
import drzhark.mocreatures.client.renderer.entity.MoCRenderPlatform;
import drzhark.mocreatures.client.renderer.entity.MoCRenderRaccoon;
...
import drzhark.mocreatures.client.renderer.entity.MoCRenderRoach;
...
import drzhark.mocreatures.client.renderer.entity.MoCRenderSilverSkeleton;
import drzhark.mocreatures.client.renderer.entity.MoCRenderSmallFish;
import drzhark.mocreatures.client.renderer.entity.MoCRenderSnail;
...
import drzhark.mocreatures.client.renderer.entity.MoCRenderTurkey;
...
public class MoCClientProxy extends MoCProxy {
    ...
    public void registerRenderInformation()
    {
        ...
        RenderingRegistry.instance().registerEntityRenderingHandler(MoCEntityTurkey.class, new MoCRenderTurkey(new MoCModelTurkey(), 0.4F));
        ...
        RenderingRegistry.instance().registerEntityRenderingHandler(MoCEntityDuck.class, new MoCRenderDuck(new MoCModelDuck(), 0.3F));
        ...
        RenderingRegistry.instance().registerEntityRenderingHandler(MoCEntityFox.class, new MoCRenderFox(new MoCModelFox(), 0.5F));
        ...
        RenderingRegistry.instance().registerEntityRenderingHandler(MoCEntityFishy.class, new MoCRenderFishy(new MoCModelFishy(), 0.1F));
        ...
        RenderingRegistry.instance().registerEntityRenderingHandler(MoCEntityBee.class, new MoCRenderBee(new MoCModelBee()));
        RenderingRegistry.instance().registerEntityRenderingHandler(MoCEntityFly.class, new MoCRenderFly(new MoCModelFly()));
        RenderingRegistry.instance().registerEntityRenderingHandler(MoCEntityDragonfly.class, new MoCRenderDragonfly(new MoCModelDragonfly()));
        ...
        RenderingRegistry.instance().registerEntityRenderingHandler(MoCEntitySnail.class, new MoCRenderSnail(new MoCModelSnail(), 0.0F));
        ...
        RenderingRegistry.instance().registerEntityRenderingHandler(MoCEntityElephant.class, new MoCRenderElephant(new MoCModelElephant(), 0.7F));
        RenderingRegistry.instance().registerEntityRenderingHandler(MoCEntityKomodo.class, new MoCRenderKomodo(new MoCModelKomodo(), 0.3F));
        RenderingRegistry.instance().registerEntityRenderingHandler(MoCEntityWyvern.class, new MoCRenderWyvern(new MoCModelWyvern(), 0.5F));
        RenderingRegistry.instance().registerEntityRenderingHandler(MoCEntityOgre.class, new MoCRenderOgre(new MoCModelOgre(), 0.6F));
        RenderingRegistry.instance().registerEntityRenderingHandler(MoCEntityRoach.class, new MoCRenderRoach(new MoCModelRoach()));
        RenderingRegistry.instance().registerEntityRenderingHandler(MoCEntityMaggot.class, new MoCRenderMaggot(new MoCModelMaggot(), 0F));
        RenderingRegistry.instance().registerEntityRenderingHandler(MoCEntityCrab.class, new MoCRenderCrab(new MoCModelCrab(), 0.2F));
        RenderingRegistry.instance().registerEntityRenderingHandler(MoCEntityRaccoon.class, new MoCRenderRaccoon(new MoCModelRaccoon(), 0.4F));
        RenderingRegistry.instance().registerEntityRenderingHandler(MoCEntityMiniGolem.class, new MoCRenderMiniGolem(new MoCModelMiniGolem(), 0.5F));
        RenderingRegistry.instance().registerEntityRenderingHandler(MoCEntitySilverSkeleton.class, new MoCRenderSilverSkeleton(new MoCModelSilverSkeleton(), 0.6F));
        RenderingRegistry.instance().registerEntityRenderingHandler(MoCEntityAnt.class, new MoCRenderAnt(new MoCModelAnt()));
        RenderingRegistry.instance().registerEntityRenderingHandler(MoCEntityMediumFish.class, new MoCRenderMediumFish(new MoCModelMediumFish(), 0.2F));
        RenderingRegistry.instance().registerEntityRenderingHandler(MoCEntitySmallFish.class, new MoCRenderSmallFish(new MoCModelSmallFish(), 0.1F));
        RenderingRegistry.instance().registerEntityRenderingHandler(MoCEntityPiranha.class, new MoCRenderPiranha(new MoCModelSmallFish(), 0.1F));
    ...
    public void initGUI()
    {
        ...
        guiapiSettings.append(ambientSpawnTickRateS = new MoCSettingInt(mocGlobalConfig, CATEGORY_CUSTOMSPAWNER_SETTINGS, "ambientSpawnTickRate", ambientSpawnTickRate, 1, 1, 1000));
        ...
        guiapiSettings.append(maxMonstersS = new MoCSettingInt(mocGlobalConfig, CATEGORY_CUSTOMSPAWNER_SETTINGS, "maxMonsters", maxMonsters, 1, 1, 1000));
        maxMonstersW = new WidgetInt(maxMonstersS, "Hostiles");
        widgetCustomSpawnerColumns.add(maxMonstersW);
        guiapiSettings.append(maxCreaturesS = new MoCSettingInt(mocGlobalConfig, CATEGORY_CUSTOMSPAWNER_SETTINGS, "maxCreatures", maxCreatures, 1, 1, 1000));
        maxCreaturesW = new WidgetInt(maxCreaturesS, "Animals");
        widgetCustomSpawnerColumns.add(maxCreaturesW);
        guiapiSettings.append(maxWaterCreaturesS = new MoCSettingInt(mocGlobalConfig, CATEGORY_CUSTOMSPAWNER_SETTINGS, "maxWaterCreatures", maxWaterCreatures, 1, 1, 1000));
        maxWaterCreaturesW = new WidgetInt(maxWaterCreaturesS, "Water Mobs");
        widgetCustomSpawnerColumns.add(maxWaterCreaturesW);
        guiapiSettings.append(maxAmbientsS = new MoCSettingInt(mocGlobalConfig, CATEGORY_CUSTOMSPAWNER_SETTINGS, "maxAmbients", maxAmbients, 1, 1, 1000));
        maxWaterCreaturesW = new WidgetInt(maxAmbientsS, "Ambient Mobs");
        widgetCustomSpawnerColumns.add(maxWaterCreaturesW);
        guiapiSettings.append(despawnVanillaB = new MoCSettingBoolean(mocGlobalConfig, CATEGORY_CUSTOMSPAWNER_SETTINGS, "DespawnVanilla", despawnVanilla));
        ...
        guiapiSettings.append(despawnTickRateS = new MoCSettingInt(mocGlobalConfig, CATEGORY_CUSTOMSPAWNER_SETTINGS, "despawnTickRate", despawnTickRate, 1, 1, 1000));
        despawnTickRateW = new WidgetInt(despawnTickRateS, "Despawn Tick R.");
        widgetCustomSpawnerColumns.add(despawnTickRateW);
        guiapiSettings.append(modifyVanillaSpawnsB = new MoCSettingBoolean(mocGlobalConfig, CATEGORY_CUSTOMSPAWNER_SETTINGS, "ModifyVanillaSpawns", modifyVanillaSpawns));
    ...
    public void showEntitySettings(MoCEntityData entityData)
    {
        if (entityData != null)
        {
            if (entityData.getEntityWindow() == null)
            {
                ...
                MoCSettingMulti settingType = new MoCSettingMulti(entityData.getEntityConfig(), CATEGORY_ENTITY_SPAWN_SETTINGS, entityData.getEntityName() + " Type", entityData.getType() != null ? entityTypes.indexOf(entityData.getType().toString().toUpperCase()) : 0, "UNDEFINED", "CREATURE", "MONSTER", "WATERCREATURE", "AMBIENT");
                guiapiSettings.append(settingType);
                widgetEntitySettingColumn.add(new WidgetMulti(settingType, "Type"));
                MoCSettingInt settingFrequency = new MoCSettingInt(entityData.getEntityConfig(), CATEGORY_ENTITY_SPAWN_SETTINGS, entityData.getEntityName() + " Frequency", entityData.getFrequency(), 0, 1, 20);
                guiapiSettings.append(settingFrequency);
                widgetEntitySettingColumn.add(new WidgetInt(settingFrequency, "Frequency"));
                MoCSettingInt settingMinGroup = new MoCSettingInt(entityData.getEntityConfig(), CATEGORY_ENTITY_SPAWN_SETTINGS, entityData.getEntityName() + " Min", entityData.getMinSpawn(), 1, 1, 20);
                guiapiSettings.append(settingMinGroup);
                widgetEntitySettingColumn.add(new WidgetInt(settingMinGroup, "Min"));
                MoCSettingInt settingMaxGroup = new MoCSettingInt(entityData.getEntityConfig(), CATEGORY_ENTITY_SPAWN_SETTINGS, entityData.getEntityName() + " Max", entityData.getMaxSpawn(), 1, 1, 20);
                guiapiSettings.append(settingMaxGroup);
                widgetEntitySettingColumn.add(new WidgetInt(settingMaxGroup, "Max"));
                MoCSettingInt settingChunkGroup = new MoCSettingInt(entityData.getEntityConfig(), CATEGORY_ENTITY_SPAWN_SETTINGS, entityData.getEntityName() + " Chunk", entityData.getMaxInChunk(), 1, 1, 20);
