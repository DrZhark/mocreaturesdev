        ...
        for (var11[par5] = var10[par5]; var12 <= var7; ++var12)
        {
            ...
            while (var13 <= var7)
            {
                ...
                else
                {
                    ...
                    {
                        this.func_150516_a(this.worldObj, var11[0], var11[1], var11[2], par6, MetadataLeaf);
                        ++var13;
                    }
                }
            }
    ...
    void placeBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger, Block par3)
    {
        ...
        if (var4[var6] != 0)
        {
            ...
            for (int var16 = var4[var6] + var9; var15 != var16; var15 += var9)
            {
                ...
                this.func_150516_a(this.worldObj, var14[0], var14[1], var14[2], par3, MetadataLog);//var17);
            }
        }
    }
