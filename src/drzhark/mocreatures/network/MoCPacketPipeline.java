...
public class MoCPacketPipeline extends MessageToMessageCodec<FMLProxyPacket, AbstractPacket> {
    ...
    public void initalise() {
        this.channels = NetworkRegistry.INSTANCE.newChannel("MoCreatures", this);
    }
