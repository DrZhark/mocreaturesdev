...
public class MoCRenderKitty extends RenderBiped {
    ...
    public MoCRenderKitty(MoCModelKitty modelkitty, float f) {
        super(MoCClientProxy.mc.getRenderManager(), modelkitty, f);
        ...
        if (entitykitty.renderName()) {
            ...
            if (f4 < 12F) {
                ...
                if (flag1) {
                    ...
                    tessellator.getWorldRenderer().addVertex(-15F + f10, -8 + byte0, 0.0D);
                    tessellator.getWorldRenderer().addVertex(-15F + f10, -4 + byte0, 0.0D);
                    tessellator.getWorldRenderer().addVertex(15D, -4 + byte0, 0.0D);
                    tessellator.getWorldRenderer().addVertex(15D, -8 + byte0, 0.0D);
                    tessellator.getWorldRenderer().setColorRGBA_F(0.0F, 0.7F, 0.0F, 1.0F);
                    tessellator.getWorldRenderer().addVertex(-15D, -8 + byte0, 0.0D);
                    tessellator.getWorldRenderer().addVertex(-15D, -4 + byte0, 0.0D);
                    tessellator.getWorldRenderer().addVertex(f10 - 15F, -4 + byte0, 0.0D);
                    tessellator.getWorldRenderer().addVertex(f10 - 15F, -8 + byte0, 0.0D);
                    tessellator.draw();
                ...
                if (flag) {
                    ...
                    tessellator.getWorldRenderer().addVertex(-j - 1, -1 + byte0, 0.0D);
                    tessellator.getWorldRenderer().addVertex(-j - 1, 8 + byte0, 0.0D);
                    tessellator.getWorldRenderer().addVertex(j + 1, 8 + byte0, 0.0D);
                    tessellator.getWorldRenderer().addVertex(j + 1, -1 + byte0, 0.0D);
                    tessellator.draw();
                    GL11.glEnable(3553 /* GL_TEXTURE_2D */);
